                ...
                <div class="col">
                    <div class="page-title">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Resend Email</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="user-login-register bg-light rounded-4">
                        <div class="login-register-title" >
                            <h2 class="title">Resend Email Verification</h2>
                        </div>
                        <div class="login-register-form">
                            ...
                            <form action="resend-code.php" method="POST">
                                ...
                                <div class="col-12 text-center learts-mb-50">
                                    <button class="btn btn-dark btn-outline-hover-dark" type="submit" name="resend">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
